...
/**
 * Klasa abstrakcyjna, na podstawie któej tworzone są rodzaje zakłóceń maszyn (klasy SlowGlitch, TurnOffGLitch)
...
public abstract class Glitch {
    ...
    /**
     * Zawiera informacje o tym, czy glitch juz sie skonczyl
     */
